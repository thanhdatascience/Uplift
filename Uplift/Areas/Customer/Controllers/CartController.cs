    ...
    public class CartController : Controller
    {
            ...
            if(HttpContext.Session.GetObject<List<int>>(SD.SessionCart)!=null)
            {
                ...
                foreach(int serviceId in sessionList)
                {
                    CartVM.ServiceList.Add(
                        _unitOfWork.Service.GetFirstOrDefault(u => u.Id == serviceId, includeProperties: "Frequency,Category"));
                }
            }
            return View(CartVM);
        }
        ...
        public IActionResult SummaryPOST()
        {
            if (HttpContext.Session.GetObject<List<int>>(SD.SessionCart) != null)
            {
                ...
                {
                    CartVM.ServiceList.Add(
                        _unitOfWork.Service.Get(serviceId));
                }
            }
            ...
            else
            {
                ...
                CartVM.OrderHeader.Status = SD.StatusSubmited;
                ...
                HttpContext.Session.SetObject(SD.SessionCart, new LinkedList<int>());
